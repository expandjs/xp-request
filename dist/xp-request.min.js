...
!function(e){"use strict";var t=require("http"),n=require("https"),i=require("expandjs"),r=require("xp-emitter");module.exports=new i.Class("XPRequest",{"extends":r,options:{dataType:"text",headers:null,keepAlive:0,method:"GET",url:""},initialize:{promise:!0,value:function(e,t){i.assertArgument(i.isObject(e)||i.isString(e,!0),1,"Object or string");var n=this;r.call(n),n.chunks=[],n.options=i.isString(e)?{}:e,n.dataType=n.options.dataType,n.headers=n.options.headers||{},n.keepAlive=n.options.keepAlive,n.method=n.options.method,n.url=n.options.url,n.resolver=t,n.state="idle",n.adapt(),n.adaptee.on("error",n.handleError.bind(n)),n.adaptee.on("response",n.handleResponse.bind(n))}},abort:function(){var e=this;return e.timeAbort?e:(e.adaptee.abort(),e.state="aborted",e.timeAbort=Date.now(),e)},send:function(e){i.assertArgument(i.isVoid(e)||Buffer.isBuffer(e)||i.isString(e,!0),1,"Buffer or string");var t=this;return t.timeSend?t:(t.adaptee.end(e),t.state="pending",t.timeSend=Date.now(),t)},adapt:{enumerable:!1,value:function(){var r=i.parseURL(this.url),s=i.assign(this,{secure:"https:"===(r.protocol||e.location.protocol)}),a=s.secure?443:80,o=s.secure?n:t;return s.adaptee=o.request({auth:r.auth,headers:s.headers,hostname:r.hostname||e.location.hostname,keepAlive:s.keepAlive>0,keepAliveMsecs:Math.max(s.keepAlive,0),method:s.method,path:r.path+(r.hash||""),port:r.port||r.hostname&&a||e.location.port}),s}},parse:{enumerable:!0,value:function(e){var t=this;return"json"===t.dataType?JSON.parse(e):e}},adaptee:{enumerable:!1,set:function(e){return this.request||e},validate:function(e){return i.isObject(e)}},chunks:{set:function(e){return this.chunks||e},validate:function(e){return i.isArray(e)}},data:{validate:function(e){return i.isString(e)||Buffer.isBuffer(e)}},dataType:{set:function(e){return this.dataType||e},validate:function(e){return i.includes(this.dataTypes,e)}},dataTypes:{frozen:!0,writable:!1,value:["json","text"]},headers:{set:function(e){return this.headers||e},validate:function(e){return i.isObject(e)}},keepAlive:{set:function(e){return this.keepAlive>=0?this.keepAlive:e},validate:function(e){return i.isInt(e,!0)}},method:{set:function(e){return this.method||i.upperCase(e)},validate:function(e){return i.isString(e,!0)}},response:{set:function(e){return this.response||e},validate:function(e){return i.isObject(e)}},secure:{set:function(e){return i.isBoolean(this.secure)?this.secure:!!e}},state:{then:function(e){this.emit("state",e,this)},validate:function(e){return i.includes(this.states,e)}},states:{frozen:!0,writable:!1,value:["aborted","failed","idle","pending","received","receiving"]},timeAbort:{set:function(e){return this.timeAbort||e},validate:function(e){return i.isFinite(e,!0)}},timeData:{set:function(e){return this.timeData||e},validate:function(e){return i.isFinite(e,!0)}},timeResponse:{set:function(e){return this.timeResponse||e},validate:function(e){return i.isFinite(e,!0)}},timeSend:{set:function(e){return this.timeSend||e},validate:function(e){return i.isFinite(e,!0)}},url:{set:function(e){return this.url||e},validate:function(e){return i.isString(e,!0)}},handleData:function(e){var t=this;t.chunks.push(e),t.emit("chunk",e,t)},handleEnd:function(){var e=this;try{e.data=e.parse(Buffer.isBuffer(e.chunks[0])?Buffer.concat(e.chunks):e.chunks.join("")),e.state="received",e.timeData=Date.now()}catch(t){return e.handleError(t.message)}e.resolver(null,e.data),e.emit("data",e.data,e)},handleError:function(e){var t=this;t.state="failed",t.timeResponse=Date.now(),t.timeData=t.timeResponse,t.resolver(e),t.emit("response",null,t),t.emit("error",e,t)},handleResponse:function(e){var t=this;t.response=e,t.state="receiving",t.timeResponse=Date.now(),e.on("data",t.handleData.bind(t)),e.on("end",t.handleEnd.bind(t)),t.emit("response",e,t)}})}("undefined"!=typeof window?window:global);
